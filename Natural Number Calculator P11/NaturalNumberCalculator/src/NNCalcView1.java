...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        JScrollPane inputPane = new JScrollPane(this.tTop);
        JScrollPane outputPane = new JScrollPane(this.tBottom);
        /*
    ...
    public void updateTopDisplay(NaturalNumber n) {
        String nnstr = n.toString();
        this.tTop.setText(nnstr);
