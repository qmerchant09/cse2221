...
public final class CryptoUtilities {
    ...
    public static boolean isEven(NaturalNumber n) {
        //removes the last digit of the number and checks if it is even
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        if (p.isZero()) {
            ...
            powerMod(n, p, m);
            n.power(2);
            n.multiply(nCopy.divide(m));
            NaturalNumber r = n.divide(m);
            n.transferFrom(r);
        }
        p.transferFrom(pCopy);
    }
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        NaturalNumber nCopy = n.newInstance();
        nCopy.copyFrom(n);
        NaturalNumber one = w.newInstance();
        one.setFromInt(1);
        NaturalNumber two = w.newInstance();
        two.setFromInt(2);
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        if (n.compareTo(new NaturalNumber2(THREE)) <= 0) {
            ...
            for (int i = 0; i < fifty; i++) {
                NaturalNumber random = randomNumber(nCopy);
                while (!(random.compareTo(one) > 0
                        && random.compareTo(nCopy) < 0)) {
