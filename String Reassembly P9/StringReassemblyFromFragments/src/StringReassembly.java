...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        String str3 = str1.substring(0, str1.length() - overlap) + str2;
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        boolean b = true;
        for (String fromSet : strSet) {
            if (fromSet.indexOf(str) >= 0) {
                b = false;
            }
        }
        ...
        if (b) {
            strSet.add(str);
            Set<String> copySet = strSet.newInstance();
            for (String fromSet : strSet) {
                if (fromSet.equals(str)) {
                    copySet.add(fromSet);
                } else {
                    if (str.indexOf(fromSet) == -1) {
                        copySet.add(fromSet);
                    }
                }
            }
            strSet.transferFrom(copySet);
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        while (!input.atEOS()) {
            ...
            addToSetAvoidingSubstrings(setStr, str);
        }
